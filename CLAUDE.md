...
| Table | Key columns |
|---|---|
| `profiles` | display_name, timezone, preferred_send_hour, reminder_days_before, drips_sent, consent_terms, consent_emails, email_reminders_enabled, monthly_digest_enabled, last_digest_sent, onboarding_completed, **updated_at, last_changed_fields** |
