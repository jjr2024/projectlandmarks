...
-- 3. Drop old category check constraint
-- 4. Wipe all placeholder seed data from gift_catalog (migration 004)
-- 5. Insert 67 real products from XLS v2.0 with clean affiliate URLs
-- 6. Add new category check constraint (after old rows gone, new rows in)
-- 7. Remap contacts.gift_categories arrays (existing user data)
-- 8. Remap profiles.default_gift_categories arrays
-- 9. Update column defaults
--
...
-- ── 3. Drop old category check constraint ──────────────────────────────────
-- Old constraint (migration 001): flowers, wine, treats, gift_card, experiences, donation, home, accessories
-- Must drop BEFORE deleting old data and inserting new, because ADD CONSTRAINT
-- validates all existing rows. New constraint is added in step 6 after insert.
ALTER TABLE public.gift_catalog
  DROP CONSTRAINT IF EXISTS gift_catalog_category_check;

-- ── 4. Wipe all placeholder seed data ──────────────────────────────────────
-- Migration 004 seeded ~30 placeholder items. Remove them all; real products below.
...
-- ── 5. Insert 67 real products from XLS v2.0 ──────────────────────────────
...
-- ── Flowers (6) ────────────────────────────────────────────────
('The Sorbet Flower Bouquet', 'urbanstems', 'https://urbanstems.com/products/the-sorbet', 'flowers', 'mid', 'Roses, carnations, and veronica arranged in soft pastel tones.', '{flower,flowers,roses,carnations,veronica,bouquet}', '{}', '{all}', '{all}', true),
('The Firecracker Flower Bouquet', 'urbanstems', 'https://urbanstems.com/products/the-firecracker', 'flowers', 'mid', 'A bold arrangement of roses, thistle, and craspedia in warm tones.', '{flower,flowers,thistle,roses,bouquet,craspedia}', '{}', '{all}', '{all}', true),
...
('The Good Vibes Flower Bouquet', 'urbanstems', 'https://urbanstems.com/products/the-good-vibes', 'flowers', 'mid', 'A warm and cheerful mix of orange roses, delphinium, and lisianthus.', '{flower,flowers,bouquet,orange,roses,delphinium,lisianthus}', '{}', '{all}', '{all}', true),
('The Coquette Flower Bouquet', 'urbanstems', 'https://urbanstems.com/products/the-coquette', 'flowers', 'mid', 'Pink roses paired with hypericum berries and lush seasonal greenery.', '{flower,flowers,bouquet,pink,roses,hypericum,berries,greenery}', '{}', '{all}', '{all}', true),
('The Unicorn Flower Bouquet', 'urbanstems', 'https://urbanstems.com/products/the-unicorn', 'flowers', 'mid', 'A playful purple, pink, and white arrangement with roses and carnations.', '{flower,flowers,bouquet,purple,pink,white,roses,carnations,alstroemeria}', '{}', '{all}', '{all}', true),
...
('Grand Napa Vineyards Los Carneros Chardonnay 2024', 'wine.com', 'https://www.wine.com/product/grand-napa-vineyards-los-carneros-chardonnay-2024/2880817', 'wine', 'mid', 'Bright California chardonnay with balanced citrus and a touch of oak.', '{whitewine,wine,chardonnay,white}', '{}', '{all}', '{all}', true),
...
('Grand Napa Vineyards Los Carneros Pinot Noir 2023', 'wine.com', 'https://www.wine.com/product/grand-napa-vineyards-los-carneros-pinot-noir-2023/2918279', 'wine', 'mid', 'Light and earthy pinot noir from Los Carneros with soft berry notes.', '{wine,alcohol,pinot,noir,red,napa}', '{}', '{all}', '{all}', true),
('Veuve Clicquot Yellow Label Brut', 'wine.com', 'https://www.wine.com/product/veuve-clicquot-yellow-label-brut/528', 'wine', 'mid', 'Well-known Veuve Clicquot champagne. Dry, balanced, and full-bodied.', '{wine,alcohol,brut,champagne,veuve}', '{}', '{all}', '{all}', true),
...
('Sony WH-CH520 Wireless Headphones', 'amazon', 'https://www.amazon.com/dp/B0BS1PRC4L?tag=daysightremin-20', 'electronics', 'mid', 'Lightweight wireless headphones with a 50-hour battery and clear sound.', '{headphone,wireless,sony,music,podcast}', '{}', '{all}', '{all}', true),
...
-- ── Sports (6) ─────────────────────────────────────────────────
('ZELUS Weighted Vest for Workout', 'amazon', 'https://www.amazon.com/dp/B07518RBH2?tag=daysightremin-20', 'sports', 'mid', 'Adjustable weighted vest for bodyweight training and running drills.', '{weight,sport,exercise,workout,strength,strong}', '{man}', '{all}', '{all}', true),
('Titleist Pro V1 Golf Balls', 'amazon', 'https://www.amazon.com/dp/B0DPN7QZ9R?tag=daysightremin-20', 'sports', 'mid', 'Tour-level golf balls with long distance and consistent short game.', '{golf,golfing,titleist,prov1}', '{man}', '{all}', '{all}', true),
...
('Optimum Nutrition Gold Standard 100% Whey Protein Powder', 'amazon', 'https://www.amazon.com/dp/B000GISTZ4?tag=daysightremin-20', 'sports', 'mid', 'Popular whey protein powder for post-workout recovery. 24g protein per serving.', '{protein,powder,sports,workout,whey,lifting,weightlift}', '{man}', '{all}', '{all}', true),

-- ── Apparel (6) ────────────────────────────────────────────────
('Crocs Classic Clog', 'amazon', 'https://www.amazon.com/dp/B0FBS23TFH?tag=daysightremin-20', 'apparel', 'mid', 'Lightweight, cushioned, and easy to clean. Fits a wide range of occasions.', '{shoe,crocs,clog,shoes}', '{}', '{all}', '{all}', true),
...
('luvamia Wide Leg Jeans for Women', 'amazon', 'https://www.amazon.com/dp/B0CP9HK36V?tag=daysightremin-20', 'apparel', 'mid', 'Relaxed-fit wide-leg jeans with a flattering high waist and deep pockets.', '{woman,jeans,pants,flare,baggy,pockets,she,her}', '{woman}', '{all}', '{all}', true),
('AUTOMET Women''s Oversized Jeans Jacket', 'amazon', 'https://www.amazon.com/dp/B0D8VTLXTC?tag=daysightremin-20', 'apparel', 'mid', 'Oversized denim jacket that layers well over almost anything casual.', '{woman,jeans,jacket,pockets,she,her}', '{woman}', '{all}', '{all}', true),
...
('Swarovski Stone Crystal Pierced Hoop Earring Jewelry Collection', 'amazon', 'https://www.amazon.com/dp/B095VF1VZR?tag=daysightremin-20', 'jewelry', 'mid', 'Sparkling crystal hoop earrings that work for everyday or dressed up.', '{woman,jewelry,earring,she,her,crystal,hoop,ear}', '{woman}', '{all}', '{all}', true),
...
('RYZE SUPERFOODS Mushroom Coffee with 6 Adaptogenic Mushrooms', 'amazon', 'https://www.amazon.com/dp/B0FSGHP1FC?tag=daysightremin-20', 'wellness', 'mid', 'Mushroom-based coffee alternative with mushroom extract and less caffeine.', '{supplement,immune,sport,athlete,healthy,nutrition,nutrient,coffee,mushroom,superfood,keto}', '{}', '{all}', '{all}', true),
...
-- ── 6. Add new category check constraint ───────────────────────────────────
-- Now that old rows are gone and new rows are in, safe to enforce.
ALTER TABLE public.gift_catalog
  ADD CONSTRAINT gift_catalog_category_check
  CHECK (category IN ('flowers', 'wine', 'food_snacks', 'home', 'books', 'electronics', 'sports', 'apparel', 'beauty', 'jewelry', 'wellness', 'games_toys', 'pet'));

-- ── 7. Remap contacts.gift_categories arrays ────────────────────────────────
...
UPDATE public.contacts
SET gift_categories = array_remove(gift_categories, 'donation')
WHERE 'donation' = ANY(gift_categories);
...
-- ── 8. Remap profiles.default_gift_categories ───────────────────────────────
...
UPDATE public.profiles
SET default_gift_categories = array_remove(default_gift_categories, 'donation')
WHERE 'donation' = ANY(default_gift_categories);
